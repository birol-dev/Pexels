...
const OpenAIIcon = () => (
  <svg viewBox="-0.17090198558635983 0.482230148717937 41.14235318283891 40.0339509076386" className="h-5 w-5 text-primary">
    <title>OpenAI</title>
...
const OpenRouterIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" className="h-5 w-5 text-on-surface-variant flex-shrink-0">
...
export default function SettingsView(): React.JSX.Element {
  ...
  const testPexelsConnection = async () => {
    ...
    try {
      ...
      setPexelsTestResult({ success: false, message: err?.message || 'Pexels verification failed.' })
    } finally {
  ...
  const handleResetOnboarding = async () => {
    if (confirm('Are you sure you want to reset onboarding? This will route you back to the initial setup wizard.')) {
      await updateSettings({ isOnboarded: false })
      window.location.reload()
    }
  }

  const handleProviderChange = (prov: 'openai' | 'gemini' | 'openrouter') => {
    const defaults = {
      openai: 'gpt-4o',
            ...
            <div className="flex flex-col gap-4">
              <label className="flex items-center justify-between cursor-pointer group">
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-outline font-medium">Filter sensitive results</span>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-outline font-medium">For abstract stock requests</span>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-outline font-medium">Pause before downloads</span>
                </div>
                <input
                  type="checkbox"
        ...
        {saveResult && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-[11px] mt-0.5 leading-normal opacity-90">{saveResult.message}</div>
            </div>
          </div>
        )}
        ...
        {llmTestResult && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-[11px] mt-0.5 leading-normal opacity-90">{llmTestResult.message}</div>
            </div>
          </div>
        )}
        ...
        {pexelsTestResult && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-[11px] mt-0.5 leading-normal opacity-90">{pexelsTestResult.message}</div>
            </div>
          </div>
        )}
      </div>
