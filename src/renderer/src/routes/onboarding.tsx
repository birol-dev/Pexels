...
const GeminiIcon = () => (
  <svg viewBox="0 0 24 24" className="h-9 w-9 text-[#3186FF] flex-shrink-0">
    ...
    <defs>
      <linearGradient id="lobe-icons-gemini-0-_R_0_" x1="7" y1="15.5" x2="11" y2="12" gradientUnits="userSpaceOnUse">
        <stop stopColor="#08B962"></stop>
        <stop offset="1" stopColor="#08B962" stopOpacity="0"></stop>
      </linearGradient>
      <linearGradient id="lobe-icons-gemini-1-_R_0_" x1="8" y1="5.5" x2="11.5" y2="11" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F94543"></stop>
        <stop offset="1" stopColor="#F94543" stopOpacity="0"></stop>
      </linearGradient>
      <linearGradient id="lobe-icons-gemini-2-_R_0_" x1="3.5" y1="13.5" x2="17.5" y2="12" gradientUnits="userSpaceOnUse">
...
const OpenRouterIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" className="h-9 w-9 text-on-surface-variant flex-shrink-0">
...
export default function OnboardingView(): React.JSX.Element {
  ...
  const handleProviderSelect = (prov: 'openai' | 'gemini' | 'openrouter') => {
    setLlmProvider(prov)
    const defaults = {
      openai: 'gpt-4o',
  ...
  const testLlmConnection = async () => {
    setTestingLlm(true)
    setLlmTestResult(null)
    const activeKey = llmProvider === 'openai' ? openaiKey : llmProvider === 'gemini' ? geminiKey : openrouterKey
    try {
      ...
      setLlmTestResult({ success: false, message: err?.message || 'Connection test failed.' })
    } finally {
      setTestingLlm(false)
    }
  }
  ...
  const testPexelsConnection = async () => {
    ...
    try {
      ...
      setPexelsTestResult({ success: false, message: err?.message || 'Pexels test failed.' })
    } finally {
          ...
          <div className="bg-white/55 backdrop-blur-[16px] border border-white/40 shadow-[0px_20px_40px_rgba(0,0,0,0.05),0px_4px_8px_rgba(0,0,0,0.04)] rounded-2xl p-12 flex flex-col items-center text-center">
            ...
            <div className="flex items-center gap-3 mb-12">
              <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center border border-primary/20 shadow-sm">
                <span className="material-symbols-outlined text-primary text-[24px]">movie_filter</span>
              </div>
            ...
            <div className="max-w-md mx-auto flex flex-col items-center">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-10 leading-relaxed">
                Our AI agent analyzes your script, finds matching media on Pexels, and downloads it into organized folders in minutes.
              </p>
          ...
          <div className="bg-white/55 backdrop-blur-[16px] border border-white/40 shadow-[0px_20px_40px_rgba(0,0,0,0.05),0px_4px_8px_rgba(0,0,0,0.04)] rounded-2xl p-10 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1 text-center items-center">
              ...
              <p className="text-xs text-on-surface-variant max-w-lg mt-1">
                Select the Large Language Model provider that will power your script analysis and visual prompt generation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-2">
              ...
              >
                <div className="mb-2"><OpenAIIcon /></div>
              ...
              >
                <div className="mb-2"><GeminiIcon /></div>
              ...
              >
                <div className="mb-2"><OpenRouterIcon /></div>
          ...
          <div className="bg-white/55 backdrop-blur-[16px] border border-white/40 shadow-[0px_20px_40px_rgba(0,0,0,0.05),0px_4px_8px_rgba(0,0,0,0.04)] rounded-2xl p-10 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1 text-center items-center">
              ...
              <h2 className="text-2xl font-bold text-on-surface mt-1 flex items-center gap-2">
                <span className="material-symbols-outlined text-[28px] text-[#05a081]">photo_library</span>
                Connect Pexels
              </h2>
              <p className="text-xs text-on-surface-variant max-w-lg mt-1">
                StockFinder AI uses the Pexels API to search and retrieve high-quality stock b-roll footage. Let's link your Pexels developer key.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6 bg-white/30 rounded-xl p-6 border border-white/40 shadow-inner">
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-surface-container-low/50 border border-outline-variant/20">
                ...
                <p className="text-[11px] text-on-surface-variant leading-relaxed">
                  Your API key is stored locally in your system's secure keychain. It is strictly used to fetch footage directly from Pexels and is never sent to external servers.
                </p>
              </div>
            </div>
        ...
        {step === 4 && (
          <div className="bg-white/55 backdrop-blur-[16px] border border-white/40 shadow-[0px_20px_40px_rgba(0,0,0,0.05),0px_4px_8px_rgba(0,0,0,0.04)] rounded-2xl p-10 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1 text-center items-center">
              ...
              <p className="text-xs text-on-surface-variant max-w-lg mt-1">
                Configure the local storage folder where StockFinder AI will download photos, videos, and project manifests.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mb-8 max-w-lg text-left">
              ...
              <div className="glass-card rounded-xl p-4 flex items-start gap-3">
                <div className="w-9 h-9 rounded-full bg-secondary-fixed/30 flex-shrink-0 flex items-center justify-center border border-secondary-fixed-dim text-secondary">
                  {llmProvider === 'openai' ? <OpenAIIcon /> : llmProvider === 'gemini' ? <GeminiIcon /> : <OpenRouterIcon />}
                </div>
                <div>
              ...
              <div className="glass-card rounded-xl p-4 flex items-start gap-3 sm:col-span-2">
                ...
                <div className="flex-grow overflow-hidden">
                  <h4 className="font-semibold text-xs text-on-surface mb-0.5">Local Export Directory</h4>
